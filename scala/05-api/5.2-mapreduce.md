...
Here is an example
    ...
    $   ~/apps/spark/bin/spark-submit --class 'x.Clickstream'  --driver-class-path  logging   target/scala-2.10/testapp_2.10-1.0.jar    '../data/click-stream/clickstream.csv'
...
### STEP 6 : Process Generated Clickstream Data
    ...
    $    ~/apps/spark/bin/spark-submit --class 'x.Clickstream'   --driver-class-path  logging   target/scala-2.11/testapp_2.11-1.0.jar    '../data/click-stream/*.csv'
